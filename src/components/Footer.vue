<template>
  <div>
    <div
      :class="[
        'flex',
        $device.isMobile ? 'flex-col gap-4 items-center' : 'justify-between',
        'font-raleway',
        'flex-nowrap',
        'w-full',
      ]"
    >
      ...
      <div :class="['flex', 'flex-col', 'content-center', 'basis-1/5', $device.isMobile? 'self-center text-center':'mr-36']">
        <div
          class="
            inline-flex
            flex-col
