<template>
  <div class="flex flex-col gap-4 px-4">
    ...
    <p class="text-lg">
      Прежде всего, убеждённость некоторых оппонентов представляет собой
...
.images-line {
  animation: runner 85s linear infinite alternate;
...
.images-line_reverse {
  animation: runner-reverse 85s linear infinite alternate;
